...
const AuditorQualification = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:8000/api/auditor-qualifications/auditortypes')
      .then(response => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    axios.post('http://localhost:8000/api/auditor-qualifications', formDataToSend, {
      headers: {
  ...
  return (
    <><ToastContainer /><form onSubmit={handleSubmit}>
      ...
      <div className="flex flex-col md:flex-row md:space-x-4 mt-3">
        ...
        <div className="flex flex-col w-full mb-4 md:mb-0">
          <label htmlFor="name" className="font-medium text-black dark:text-white mb-1">
            Name
          </label>
          <Form.Control
            id="name"
        ...
        {/* Education Field */}
        <div className="flex flex-col w-full mb-4 md:mb-0">
          <label htmlFor="education" className="font-medium text-black dark:text-white mb-1">
            Education
          </label>
          <Form.Control
            id="education"
        ...
        {/* Zone Field */}
        <div className="flex flex-col w-full mb-4 md:mb-0">
          <label htmlFor="zone" className="font-medium text-black dark:text-white mb-1">
            Zone
          </label>
          <Form.Control
            id="zone"
      ...
      <div className="flex flex-col md:flex-row md:space-x-4 mt-3">
        ...
        <div className="flex flex-col w-full mb-4 md:mb-0">
          <label htmlFor="auditorSelectType" className="font-medium text-black dark:text-white mb-1">
            Auditor Type
          </label>
          <Form.Control
        ...
        <div className="flex flex-col w-full mb-4 md:mb-0">
          <label htmlFor="mobileNo" className="font-medium text-black dark:text-white mb-1">
            Mobile No.
          </label>
          <Form.Control
            id="mobileNo"
        ...
        {/* Scheme */}
        <div className="flex flex-col w-full mb-4 md:mb-0">
          <label htmlFor="scheme" className="font-medium text-black dark:text-white mb-1">
            Scheme
          </label>
          <Form.Control
            id="scheme"
      ...
      <div className="flex flex-col mt-3">
        <label htmlFor="selectCV" className="font-medium text-black dark:text-white mb-1">
          Select CV
        </label>
        <Form.Control
          type="file"
      ...
      <div className="flex flex-col w-full mb-4 mt-2">
        <label htmlFor="remark" className="font-medium text-black dark:text-white mb-1">
          Remark
        </label>
        <Form.Control
          id="remark"
